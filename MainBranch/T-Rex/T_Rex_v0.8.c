...
// declarando todas funcoes para evitar warnings
// sera corrigido com arquivos headers
...
int colisao()
{
    ...
    for (i = 0; i < 7; i++)
    {
        ...
        /* if (cactus_xA[i] <= 10 + dino_x[7] || cactus_xA[i] <= 10 + dino_x[8] || cactus_xA[i] <= 10 + dino_x[9] || cactus_xA[i] <= 10 + dino_x[10] || cactus_xA[i] <= 10 + dino_x[11] || cactus_xA[i] <= 10 + dino_x[12] || cactus_xA[i] <= 10 + dino_x[13])
            return 1;
        else if (cactus_xB[i] <= 10 + dino_x[7] || cactus_xB[i] <= 10 + dino_x[8] || cactus_xB[i] <= 10 + dino_x[9] || cactus_xB[i] <= 10 + dino_x[10] || cactus_xB[i] <= 10 + dino_x[11] || cactus_xB[i] <= 10 + dino_x[12] || cactus_xB[i] <= 10 + dino_x[13])
            return 1;
        else
            return 0; */
    }
