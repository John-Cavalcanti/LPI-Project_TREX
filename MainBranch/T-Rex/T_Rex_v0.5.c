...
void pegaPontuacao(int pontos)
{
    ...
    do
    {
        ...
        {
            printf("\n\n\n\n\n                   Sua pontua%cao final : %d\n\n", 135, gameOverData.pontuacao);
            printf("Digite seu nome, deve conter 3 d%cgitos: ",161);
        }
...
{
    printf("\n              Jogo feito por :\n\n\n");
    printf("                -Gabriel Pereira     Game Engine\n");
    printf("                                            %c\n",191);
    printf("                -Bernardo Diniz             %c\n", 179);
    printf("                -Jo%co Victor Pereira S.     %c  Cria%c%co, responsividade de Layouts e anima%coes\n", 134, 195, 135, 134, 135);
    printf("                -Riquelme Lopes             %c",179);
    printf("\n                                            %c\n\n\n",217);
